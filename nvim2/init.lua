...
vim.opt.foldenable = false    -- Отключает сворачивание при открытии файла
vim.opt.foldlevel = 99        -- Устанавливает высокий уровень, чтобы всё было открыто
...
-- Функция для удаления фона у основных групп подсветки
...
-- Если тема Solarized8 сбрасывает настройки, добавьте это:
